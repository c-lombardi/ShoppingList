...
public class Shopping_List extends AppCompatActivity {
        ...
        if (session.getSessionPhoneNumber().isEmpty() || override) {
            ...
            alert.setPositiveButton("Enter", new DialogInterface.OnClickListener() {
                ...
                public void onClick(final DialogInterface dialog, final int which) {
                    ...
                    editor.apply();
                    new Client.ClientBuilder(ByteCommand.getListOfShoppingLists, activity.getPreferences(MODE_PRIVATE).getString(StaticVariables.IpAddressString, StaticVariables.ActualHardCodedIpAddress), null).build().execute();
            ...
            alert.setPositiveButton("Enter", new DialogInterface.OnClickListener() {
                ...
                public void onClick(final DialogInterface dialog, final int which) {
                    try {
                        ...
                        editor.apply();
                        new Client.ClientBuilder(ByteCommand.getListOfShoppingLists, activity.getPreferences(MODE_PRIVATE).getString(StaticVariables.IpAddressString, StaticVariables.ActualHardCodedIpAddress), shoppingListFragment).build().execute();
    ...
    public static void setSession(final String sId, final Activity activity) {
        final SharedPreferences.Editor editor = activity.getPreferences(MODE_PRIVATE).edit();
        session.setSessionId(sId);

        if (session.getSessionId() != null) {
            editor.putString(StaticVariables.SessionIdString, sId);
        } else {
            editor.putString(StaticVariables.SessionAuthCodeString, "");
            session.setSessionAuthCode("");
        }
    ...
    public static FragmentManager getLocalFragmentManager() {
